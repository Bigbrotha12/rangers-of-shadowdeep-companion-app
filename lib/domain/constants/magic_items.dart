...
const List<MagicItem> magicItemsList = [
  ...
  MagicItem(
    ...
    effects: '{"damage_modifier":0,"fight_bonus":1,"magic":true}',
    maxUses: 5,
  ...
  MagicItem(
    ...
    description: 'At any point, the wielder can declare activating it. Weapon counts as magic and gives +1 Fight for the rest of the game.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":2,"fight_bonus":1,"magic":true}',
    maxUses: 5,
  ...
  MagicItem(
    ...
    description: 'At any point, the wielder can declare activating it. Weapon counts as magic and gives +1 Fight for the rest of the game.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":0,"range":24,"reload":"single_action","requires":"quiver","fight_bonus":1,"magic":true}',
    maxUses: 5,
  ...
  MagicItem(
    ...
    description: 'At any point, the wielder can declare activating it. Weapon counts as magic and gives +1 Fight for the rest of the game.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":2,"range":24,"reload":"load_and_fire","requires":"quiver","fight_bonus":1,"magic":true}',
    maxUses: 5,
  ...
  MagicItem(
    ...
    description: 'At any point, the wielder can declare activating it. Weapon counts as magic and gives +1 Fight for the rest of the game.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":-1,"opponent_damage_modifier":-1,"fight_bonus":1,"magic":true}',
    maxUses: 5,
  ...
  MagicItem(
    ...
    category: 'magic_weapon',
    effects: '{"damage_modifier":0,"light":true}',
    replacesWeaponType: 'hand_weapon',
  ),
  MagicItem(
    ...
    description: 'Made of precious alloys, significantly lighter but just as strong. Does not take up an item slot. May only carry one Light item at a time.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":2,"light":true}',
    replacesWeaponType: 'two_handed_weapon',
  ),
  MagicItem(
    key: 'light_dagger',
    ...
    description: 'Made of precious alloys, significantly lighter but just as strong. Does not take up an item slot. May only carry one Light item at a time.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":-1,"light":true}',
  ...
  MagicItem(
    ...
    description: 'Made of precious alloys, significantly lighter but just as strong. Does not take up an item slot. May only carry one Light item at a time.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":-1,"range":8,"shots_per_game":1,"light":true}',
  ...
  MagicItem(
    ...
    category: 'magic_weapon',
    effects: '{"damage_modifier":0,"elemental_strike":5}',
    maxUses: 3,
    replacesWeaponType: 'hand_weapon',
  ),
  MagicItem(
    ...
    description: 'Any time the wielder wins a fight and causes at least 1 point of damage, he may choose to do an additional 5 points of elemental magic damage.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":2,"elemental_strike":5}',
    maxUses: 3,
    replacesWeaponType: 'two_handed_weapon',
  ),
  MagicItem(
    ...
    description: 'Any time the wielder wins a fight and causes at least 1 point of damage, he may choose to do an additional 5 points of elemental magic damage.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":-1,"opponent_damage_modifier":-1,"elemental_strike":5}',
    maxUses: 3,
    replacesWeaponType: 'staff',
  ),
  ...
  MagicItem(
    ...
    description: 'Any time the user loses a fight in hand-to-hand combat, he may use the item to block the blow. The user still loses the fight but takes no damage.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":0,"blocking":true}',
    maxUses: 1,
    replacesWeaponType: 'hand_weapon',
  ),
  MagicItem(
    ...
    description: 'Any time the user loses a fight in hand-to-hand combat, he may use the item to block the blow. The user still loses the fight but takes no damage.',
    category: 'magic_weapon',
    effects: '{"damage_modifier":2,"blocking":true}',
    maxUses: 1,
    replacesWeaponType: 'two_handed_weapon',
  ),
  // Unique Magic Items
